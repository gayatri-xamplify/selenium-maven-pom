...
public void setUpClass() {
    logger.info("🔧 Setting up OpportunitiesDealTest");
    ...
    logger.info("✅ OpportunitiesDealTest setup completed");
}
	...
	public void DealAction() throws Exception {
		...
		logger.info("Starting test: Deal Status update in Manage deals");
		opportunitiesDealPage.dealSearch("Opened");
		opportunitiesDealPage.editDealStatus();
		opportunitiesDealPage.removeDealSearch();
		logger.info("Starting test: View deal in Manage deals");
		opportunitiesDealPage.dealView();
		logger.info("Starting test: Comment deal in Manage deals");
