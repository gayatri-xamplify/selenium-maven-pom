...
public class ScheduleEmailCampaignPage {
	private WebDriver driver;

	public ScheduleEmailCampaignPage(WebDriver driver) {
		this.driver = driver;
	}

	// Locators
	private By scheduleEmailCampaignBtn = By
	...
	public void setDynamicScheduleTime() {
		...
		System.out.println("Scheduling Email at -> Hour: " + hourToSet + " Minute: " + minuteToSet);
