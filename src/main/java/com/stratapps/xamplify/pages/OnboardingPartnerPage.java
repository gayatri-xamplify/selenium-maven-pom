...
//------------------------
	...
	public static final By onboardingPartner = By
			.xpath("/html/body/app-root/app-home/div/app-leftsidebar/div/div/ul/li[2]/ul/li[1]/a/span");
	...
	public static final By acceptTerms = By.xpath(
			"//body/app-root[1]/app-home[1]/div[1]/div[1]/app-add-partners[1]/div[4]/div[1]/div[1]/div[3]/button[2]");
	public static final By addContacts = By.xpath(
			"/html/body/app-root/app-home/div/div/app-add-partners/div[7]/div/div/div[2]/div/table/tbody/tr[1]/td[2]/input");
	...
	public static final By cfcField = By.xpath(
			"/html/body/app-root/app-home/div/div/app-add-partners/div[1]/div[3]/div[5]/div/div/div[3]/textarea");
	...
	public static final By uploadCsv = By.xpath(
			"/html/body/app-root/app-home/div/div/app-add-partners/div[1]/div[3]/div[1]/form/div/div[1]/div/div[2]/div/span");
	public static final By uploadCsvInput = By.xpath("//button[@id='uploadCSV']//input[@accept='.csv']");
	public static final By exportToExcel = By
			.xpath("//body/app-root/app-home/div/div/app-add-partners/div[1]/div[3]/div[2]/ul/li[4]/a");
	public static final By search = By.xpath("//input[@placeholder='Search']");
	public static final By clear = By.xpath(
			"/html/body/app-root/app-home/div/div/app-add-partners/div[1]/div[3]/div[6]/div/div/div[1]/div[2]/div[2]/div/button[1]");
	public static final By sort = By.xpath(
			"//select[@class='form-control SeclectBoxPaddingsAbj search_sort_shadows ng-untouched ng-pristine ng-valid']");
	...
	public static final By managePartner = By
			.xpath("/html/body/app-root/app-home/div/app-leftsidebar/div/div/ul/li[2]/ul/li[2]/a/i");
	...
	public static final By legalInGroup = By
			.xpath("//div[@id='multiselect-sample']//input[@placeholder='Select Legal Basis']");
	...
	public static final By searchOnboard = By.xpath(
			"/html/body/app-root/app-home/div/div/app-add-partners/div[1]/div[3]/div[6]/div/div/div[1]/div[2]/div[2]/div/input");
	...
	public static final By partnerFilterFieldName = By
			.xpath("//b[text()='1']/..//select[@class='form-control ng-untouched ng-pristine ng-valid']");
	public static final By partnerFilterCondition = By
			.xpath("//select[@class='form-control responsiveMargin ng-untouched ng-pristine ng-valid']");
	...
	public static final By deleteFilterRecord = By
			.xpath("//b[text()='1']/../..//div[@class='col-md-1 p0 positionForAddandDelete']//span/i");

	public static final By partnerFilterFieldName2 = By
			.xpath("//b[text()='2']/..//select[@class='form-control ng-untouched ng-pristine ng-valid']");
	public static final By partnerFilterCondition2 = By.xpath(
			"//b[text()='2']/../..//select[@class='form-control responsiveMargin ng-untouched ng-pristine ng-valid']");
	public static final By partnerFilterValue2 = By.xpath("//b[text()='2']/../..//input[@placeholder='value*']");

	public static final By mpartnerFlag = By
			.xpath("//*[@id='blur-content-div']//app-country-phone-input//div/span[@class='flag-icon flag-icon-']");
	public static final By mpartnerFlagCode = By
			.xpath("//*[@id='blur-content-div']//app-country-phone-input//div[@class='search-box']/input");
	public static final By mpartnerFlagCodeSelect = By
	...
	public static final By paginationLast = By
			.xpath("//ul[@class='pagination padding']//a/span/i[@data-original-title='Last']");
	public static final By paginationFirst = By
			.xpath("(//ul[@class='pagination padding']//a/span/i[@title='First'])[2]");
	...
	public static final By campaignList = By.xpath(
			"//*[@id='manageContacts']/div[1]/div/div/div/div[4]/div/div/div[2]/div[3]/div/div/table/tbody/tr[1]/td[9]/div/a[2]/i");
	public static final By campaignAnalytics = By.xpath(
			"//*[@id='manageContacts']/div[1]/div/div/div/div[4]/div/div/div[2]/div[3]/div/div/table/tbody/tr[1]/td[9]/div/a[3]/i");

	public static final By closesBtn = By
			.xpath("/html/body/app-root/app-home/div/div/app-user-campaigns-list-util/div/div[1]/a");
	...
	public static final By publishContentIcon = By
			.xpath("(//*[@id='partner_contact_list']/tbody/tr/td[6]/div/a[4]/i)[1]/..");

	public static final By legallInput = By.xpath("//*[@id='multiselectelement']/div/div/span[3]/input");
	public static final By legalInGroupInput = By
			.xpath("//div[@id='multiselect-sample']//input[@placeholder='Select Legal Basis']");
	...
	public static final By updatePartnerLegalBasisInput = By
			.xpath("//*[@id='multiselectelement']/div/div/span[3]/input");
	public static final By updateButton2 = By.xpath("//*[@id='addContactModal']/div/div/div[3]/button[2]");
	public static final By searchOnboardInput = By.xpath(
			"/html/body/app-root/app-home/div/div/app-add-partners/div[1]/div[3]/div[6]/div/div/div[1]/div[2]/div[2]/div/input");
	...
	public static String CreateCSVFile() {
		...
		List<String[]> partnerUserData = Arrays.asList(
				new String[] { "AutomationUser", "Test", "uACCOUNT NAME", "uACCOUNT OWNER", "uACCOUNT SUB TYPE",
						"cm1" + uniquecompany, "uCOMPANY DOMAIN", "uJOBTITLE", "us1" + getMailId, "",
						"uVERTICAL,uREGION", "uTERRITORY", "uTYPE", "uCATEGORY", "uKondapur", "uHyderabad",
						"uTelangana", "534350", "India", "2125554567" },
				new String[] { "AutomationUser", "Test", "uACCOUNT NAME", "uACCOUNT OWNER", "uACCOUNT SUB TYPE",
						"cm2" + uniquecompany, "COMPANY DOMAIN", "JOBTITLE", "us2" + getMailId, "", "VERTICAL,REGION",
						"uTERRITORY", "uTYPE", "uCATEGORY", "uKondapur", "uHyderabad", "uTelangana", "534350", "India",
						"+919999088099" });
...
///. @onboardpartnerForm is written by Ganesh ./
	...
	/// . Update partner form written by ganesh ./
...
// TODO: handle exception
		...
		// WebElement uploadElement = WaitUtil.waitForElementVisible(driver,
		// uploadCsvInput, 10);
		// uploadElement.sendKeys(filePath);
