...
public class SaveSurveyCampaignPage {

	private WebDriver driver;

	public SaveSurveyCampaignPage(WebDriver driver) {
		this.driver = driver;
	}
	...
	// Enters Survey and subject for test mail

	public void enterTestMailDetails(String Survey, String subject) {
		WaitUtil.waitForElementVisible(driver, emailInput, 60);
		ElementUtil.sendText(emailInput, Survey, driver);
