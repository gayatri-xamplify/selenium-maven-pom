...
public class ManageVideoCampaignPage {

	private static WebDriver driver;
	private WebDriverWait wait;
	private static final Logger logger = LogManager.getLogger(ManageVideoCampaignPage.class);

	public ManageVideoCampaignPage(WebDriver driver) {
		this.driver = driver;
	...
	private By VideoEdit = By.xpath("//table[@id=\"manage-campaign-list\"]/tbody/tr[1]/td[4]/div/div/ul/li[1]/a");
	...
	private By VideoCopy = By.xpath("//*[@id=\"manage-campaign-list\"]/tbody/tr[1]/td[4]/div/div/ul/li[2]/a[1]");
	private By VideoCopySaveChanges = By
	...
	// Total Video sent tile
	private By totalVideoSentTile = By.xpath("//div[1]/div[2]/div[1]/section[1]/div[1]/div[2]/button[1]");
	private By totalVideoSentSearchBox = By
			.xpath("//div[contains(@class,'modal right fade in')]//input[contains(@placeholder,'Search')]");
	private By totalVideoSentSearchIcon = By
			.xpath("//div[contains(@class,'modal right fade in')]//i[contains(@class,'fa fa-search')]");
	private By totalVideoSentClearSearch = By.xpath(
			"//div[contains(@class,'modal right fade in')]//span[contains(@class,'glyphicon glyphicon-remove')]");
	private By totalVideoSentExportDropdown = By
			.xpath("//div[contains(@class,'modal right fade in')]//i[contains(@class,'fa fa-angle-down')]");
	private By totalVideoSentExportExcel = By
			.xpath("//div[@class='btn-group gear-icon open']//a[contains(text(),'Export To Excel')]");
	private By totalVideoSentCloseModal = By
			.xpath("//div[contains(@class,'modal right fade in')]//i[contains(@class,'fa fa-times')]");
	...
	private By activeRecipientsSearchClear = By
			.xpath("//*[@id=\"VideoActionListModal\"]/div/div/div[1]/div[2]/div[2]/button[1]/span");
	...
	public void openVideoTab() {
		logger.info("Opening Video tab in Manage Campaigns...");
	...
	public void editVideoCampaign() throws InterruptedException {
		logger.info("Editing first Video campaign...");
		...
		WaitUtil.safeJsClick(driver, VideoEdit);
		...
		desc.sendKeys("Hello Video Campaign");
	...
	public void copyVideoCampaign() throws Exception {
		logger.info("Copying first Video campaign...");
		...
		safeClick(VideoCopySaveChanges);
	...
	public void previewOnlyView() throws Exception {
		logger.info("Previewing Video Campaign and closing preview...");
		Thread.sleep(1000);
	...
	public void archiveAndUnarchiveCampaign() throws InterruptedException {
		...
		// 4️⃣ BEFORE clicking Video tab — fix overlap issue
		scrollDown(300);
		Thread.sleep(300);

		// 5️⃣ Click Video tab using helper
		scrollIntoCenter(VideoTab);
		safeClick(VideoTab);
	...
	public void deleteVideoCampaign() throws InterruptedException {
		logger.info("Deleting first Video campaign...");
		Thread.sleep(1000);
	...
	public void openCampaignAnalytics() throws InterruptedException {
		logger.info("Opening Video campaign analytics...");
	...
	// ---------- 9.2 Total Video Sent ----------

	public void handleTotalVideoSentTile() {
		logger.info("Handling Total Video Sent tile...");

		WaitUtil.waitAndClick(driver, totalVideoSentTile, 60);
		WaitUtil.waitForPageToLoad(driver, 60);

		wait.until(ExpectedConditions.visibilityOfElementLocated(totalVideoSentSearchBox));

		ElementUtil.sendText(totalVideoSentSearchBox, "mounika", driver);
		WaitUtil.waitAndClick(driver, totalVideoSentSearchIcon, 60);
		WaitUtil.waitAndClick(driver, totalVideoSentClearSearch, 60);

		WaitUtil.waitAndClick(driver, totalVideoSentExportDropdown, 60);
		WaitUtil.waitAndClick(driver, totalVideoSentExportExcel, 60);

		WaitUtil.waitAndClick(driver, totalVideoSentCloseModal, 60);
	}
