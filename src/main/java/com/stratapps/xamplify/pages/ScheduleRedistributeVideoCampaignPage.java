...
public class ScheduleRedistributeVideoCampaignPage {

	private WebDriver driver;

	public ScheduleRedistributeVideoCampaignPage(WebDriver driver) {
		this.driver = driver;
	}
	...
	public boolean scheduleRedistributionVideo(String countryValue) throws InterruptedException {
