...
public class DesignPages {
	...
	public static final By savingcopiedregpublicpage = By
			.xpath("(//span[@class=\"btn btn-primary transition txt_pd-top3\"])[2]");
	public static final By okbutton1 = By.xpath("//button[@class=\"swal2-confirm styled\"]");
	public static final By Editregpublicpage = By
	...
	public static final By tabRegularProtect = By.xpath("//ul[@class=\"mix-filter\"]/li[4]");
	public static final By tabCoBrandedPublic = By.xpath("//ul[@class=\"mix-filter\"]/li[5]");
	public static final By tabCoBrandedPrivate = By.xpath("//ul[@class=\"mix-filter\"]/li[6]");
	public static final By tabCoBrandedProtect = By.xpath("//ul[@class=\"mix-filter\"]/li[7]");
	...
	public static final By CopyOrEmbed = By
			.xpath("//tr[1]/td//div//i[@class=\"fa fa-clipboard IconCustomization\"]/..");
	public static final By embedButton = By
			.xpath("//div[@id=\"landing-page-url-modal\"]//span[contains(text(), \"Copy Embed\")]");
	public static final By copylinkButton = By
			.xpath("//label[contains(text(), \"Copy Link\")]/..//span[contains(text(), \"Copy\")]");
	...
	public static final By managePageBreadcrumb = By
			.xpath("//ul[@class=\"page-breadcrumb\"]//a[text()=\"Manage Pages\"]");
	...
	public static final By sortPages = By.xpath(
			"//select[@id=\"select-dropdown\"][@class=\"form-control SeclectBoxPaddingsAbj ng-pristine ng-valid ng-touched\"]");
	...
	public static final By AnalyticsExportReport = By.xpath("//i[@class='fas fa-file-export p10']");
	...
	/* @cobrandedpublicpagecreation written by Ganesh ***/
	...
	/* @cobrandedProtectedPageSaveandClose written by Ganesh ***/
	public void cobrandedProtectedPageSaveandClose() {
		WaitUtil.waitAndSendKeys(driver, nameoftheregularpage, "cobrandedProtectPage" + timestamp, 20);
		DropdownUtil.selectByIndex(driver, pagetypedropdown, 2);
		WaitUtil.waitAndClick(driver, saveandclose, 20);
	}

	/* @designDesignPage written by Ganesh ***/
	public void designManagePage() throws InterruptedException {
		Thread.sleep(3000);
		WaitUtil.waitAndClick(driver, Designmodule, 20);
		WaitUtil.waitAndClick(driver, ManagePages, 20);
	}

	/* @PageTab written by Ganesh ***/
	public void PageTab(String selectTab) {
		...
		} else if (selectTab.equals("RegularProtect")) {
			WaitUtil.waitAndClick(driver, tabRegularProtect, 20);
		...
		} else if (selectTab.equals("CoBrandedProtect")) {
			WaitUtil.waitAndClick(driver, tabCoBrandedProtect, 20);
		} else if (selectTab.equals("All")) {
			WaitUtil.waitAndClick(driver, tabAll, 20);
		}
	}

	/* @copyPage written by Ganesh ***/
	...
	/* @CopyAndEmbeddedPage written by Ganesh ***/
	public void CopyAndEmbeddedPage() throws UnsupportedFlavorException, IOException, InterruptedException {
		...
		Thread.sleep(3000);
		WaitUtil.waitAndClick(driver, embedButton, 40);
	...
	/* @ProtectPageCopyURL written by Ganesh ***/
	public void ProtectPageCopyURL() throws UnsupportedFlavorException, IOException, InterruptedException {
		WaitUtil.waitAndClick(driver, CopyOrEmbed, 20);
		Thread.sleep(3000);
		WaitUtil.waitAndClick(driver, copylinkButton, 20);
		openPageWithUrl();
	...
	/* @PageAnalytics written by Ganesh ***/
	public void PageAnalytics() throws InterruptedException {
...
//        }
	...
	/* @ProtectPageAnalytics written by Ganesh ***/
	...
	/* @openNewWindow written by Ganesh ***/
	...
	/* @sortAndNoOfRecordPage written by Ganesh ***/
	public void sortAndNoOfRecordPage() throws InterruptedException {
		designManagePage();
		for (int i = 1; i <= 5; i++) {
