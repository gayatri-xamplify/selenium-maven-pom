...
// # Attach Contact index+1 is more or less index value
	...
	public static final By changeContactOrLead = By
			.xpath("//button[@class='button_blue bgcolor-unset p0 btn-transitions']");
	...
	public static final By campaignCommentDeal = By
			.xpath("(//a[@class='custom-icon' and @data-rel='fancybox-button'])[2]");
...
// public static final By selectDealToDate = By.xpath("");
	...
	public static final By dealStatusSelectfilter = By
			.xpath("//span[@class='e-input-group e-control-wrapper e-ddl e-lib e-keyboard e-valid-input']");
...
// public static final By campViewLeadEdit = By.xpath("(//a[@id='lead'])[2]");
	...
	public static final By leadstageinDeal = By
			.xpath("//select[@id='createdForPipelineStageId'][@placeholder='createdForPipelineStageId']");
...
//ActionUtil.hover(driver, viewDealforThisCampaign);
	...
	public static final By vendorViewCampDeal = By
			.xpath("(//table[@aria-describedby='leadTable']//tr//td[4])[1]//a[2]");
	public static final By vendorViewDealCount = By
			.xpath("(//div[@class='portlet light']//i[@class='circled-number IconCustomization fontStyleNormal'])[1]");
	...
	public void dealsPaginationandPageCount() throws InterruptedException {
		...
		// driver.findElement(dealFirstPg));
	...
	public void editDealStatus() throws InterruptedException {
		...
		WaitUtil.waitAndSendKeys(driver, commentHistoryDeal, "Update the deal Status", 20);
