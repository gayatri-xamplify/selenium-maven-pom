...
public class ManageContactsPage {
	...
	public static final By AllContactsTile = By.xpath("(//a[text()= ' Detailed view '])[1]/..");
	public static final By AllContactsTileCount = By.xpath("(//div[@class='number']/span)[1]");
	public static final By AllContactsTotalCount = By.xpath("(//span[@class='total-records-bg-color'])[1]/Strong");
	public static final By ValidContactTile = By.xpath("(//a[text()= ' Detailed view '])[2]/..");
	public static final By ValidContactTileCount = By.xpath("(//div[@class='number']/span)[2]");
	public static final By ValidContactTotalCount = By.xpath("(//span[@class='total-records-bg-color'])[1]/Strong");
	public static final By ExecludedContactTile = By.xpath("(//a[text()= ' Detailed view '])[3]/..");
	public static final By ExecludedContactTileCount = By.xpath("(//div[@class='number']/span)[3]");
	public static final By ExecludedContactTotalCount = By.xpath("(//span[@class='total-records-bg-color'])[1]/Strong");
	public static final By UndeliverableContactTile = By.xpath("(//a[text()= ' Detailed view '])[4]/..");
	public static final By UndeliverableContactTileCount = By.xpath("(//div[@class='number']/span)[4]");
	public static final By UndeliverableContactTotalCount = By
			.xpath("(//span[@class='total-records-bg-color'])[1]/Strong");
	public static final By UnsubscribedContactTile = By.xpath("(//a[text()= ' Detailed view '])[5]/..");
	public static final By UnsubscribedContactTileCount = By.xpath("(//div[@class='number']/span)[5]");
	public static final By UnsubscribedContactTotalCount = By
			.xpath("(//span[@class='total-records-bg-color'])[1]/Strong");

	private By sa9 = By.xpath("");
	...
	public void EditContactList() throws InterruptedException {
		Thread.sleep(2000);
	...
	public void ManageContactsTilesCountValidation() throws InterruptedException {
		xamplifyUtil.TileCountValidation(driver, AllContactsTile, AllContactsTileCount, AllContactsTile, 20);
		//xamplifyUtil.TileCountValidation(driver, ExecludedContactTile, ExecludedContactTileCount, ExecludedContactTotalCount, 20);
		xamplifyUtil.TileCountValidation(driver, ValidContactTile, ValidContactTileCount, ValidContactTotalCount, 20);
		xamplifyUtil.TileCountValidation(driver, UndeliverableContactTile, UndeliverableContactTileCount, UndeliverableContactTotalCount, 20);
		xamplifyUtil.TileCountValidation(driver, UnsubscribedContactTile, UnsubscribedContactTileCount, UnsubscribedContactTotalCount, 20);
	}
}
