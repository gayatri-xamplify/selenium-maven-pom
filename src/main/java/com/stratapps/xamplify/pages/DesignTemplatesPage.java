...
public class DesignTemplatesPage {
	...
	public static final By searchbutton2 = By.xpath("(//button[@type='submit'])[2]");
	public static final By Templatediv = By.xpath("(//div[@class='bar gridIconCustomization'])[1]/..");
	public static final By Templatediv2 = By.xpath("(//div[@class='bar gridIconCustomization'])[1]/..");
	public static final By creatediv = By.xpath("//div[@class='bar gridIconCustomization'][1]");
	public static final By creatediv2 = By.xpath("(//a[@class=\"Iconhover custom-icon\"])[2]");
	...
	public static final By SurveyFormsort = By
			.xpath("(//select[@class=\"form-control ng-untouched ng-pristine ng-valid\"])[1]");
	...
	public static final By SurveyFormPreview = By
			.xpath("(//i[@class='fa fa-eye IconCustomization campaignViewIcon'])[1]");
	...
	public static final By DraganddropButton = By
			.xpath("(//div[@class=\"image-drag SidebarModule_imageDrag__-XEVH\"])[3]");
	public static final By DraganddropButton1 = By.xpath(
			"//div[@class=\"sidebar-draggable--cs SidebarDraggable_sidebarDraggable__Nf2rL sidebar-draggable-button--cs\"]");
	public static final By DropElement = By.xpath("(//div[@class=\"txtTinyMce-wrapper\"])[1]");
	public static final By surveybutton = By.xpath(
			"//div[@class=\"buttonwrapper editor-wrapper buttonmodule__wrapper buttonwrapper_item_5a846028-314d-47ca-8037-1888680f4913_c027130d-560d-4e56-96dd-0184da6846ca_be29e559-13cc-4260-98ac-b90aee21f836 item_5a846028-314d-47ca-8037-1888680f4913_c027130d-560d-4e56-96dd-0184da6846ca_be29e559-13cc-4260-98ac-b90aee21f836 module--selected\"]");
	public static final By Pastesurveyformurl = By.xpath("(//p[text()='Button'])[1]");
	public static final By surveyformpreviewX = By
			.xpath("//div[@id=\"form-background-image\"]/..//button[@class=\"close-circle\"]");

	public static final By CustomFileUpload = By.xpath("//input[@id=\"file-upload\"]");
	public static final By uploadbrowserbutton = By.xpath("//button[@id=\"browse\"]");
	public static final By CopycustomRegularTemp = By.xpath("//button[text()= 'Copy Link']");
	public static final By CopycustomHTML = By.xpath("(//button[text()= 'Copy Link'])[1]");
	public static final By CopycustomImg = By.xpath("(//button[text()= 'Copy Link'])[2]");
	public static final By SaveCustomTemp = By.xpath("//button[@id='save']");
	// -------------------------------------------------------------------------------------------------------------
	...
	public void selectTemplateTab(String TabName) {
		By filterOption = By
				.xpath("//ul[contains(@class,'mix-filter')]//li[normalize-space(text())='" + TabName + "']");
...
//		WaitUtil.waitAndClick(driver, SurveyFormSearchbutton, 20);
	...
	/* @SurveyForm written by Ganesh ***/
	public void CreateCustomVideoTemplate(String TemplateType) throws InterruptedException {
		Thread.sleep(3000);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollTo(0, 200);");
		Thread.sleep(1000);
		...
		WaitUtil.waitAndClick(driver, creatediv, 20);
		Thread.sleep(2000);
		WaitUtil.waitAndSendKeys(driver, Templatename, "CustomVideoTemplate" + timestamp, 20);
		Thread.sleep(3000);
		driver.findElement(CustomFileUpload).sendKeys("D:\\\\GaneshNovemberGit\\\\selenium-maven-pom\\\\src\\\\test\\\\resources\\\\Videohtmlzip1758794348241 (1).zip");
		WaitUtil.waitAndClick(driver, SaveCustomTemp, 20);
	}

	/* @SurveyForm written by Ganesh ***/
	public void CreateCustomRegularTemplate(String TemplateType) throws InterruptedException {
		Thread.sleep(3000);
		WaitUtil.waitAndSendKeys(driver, searchtemplate, "Upload Regular Template", 20);
		WaitUtil.waitAndClick(driver, searchbutton2, 20);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollTo(0, 200);");
		Thread.sleep(1000);
		ActionUtil.hover(driver, Templatediv);
		WaitUtil.waitAndClick(driver, creatediv, 20);
		Thread.sleep(2000);
		WaitUtil.waitAndSendKeys(driver, Templatename, "CustomRegularTemplate" + timestamp, 20);
		Thread.sleep(3000);
		driver.findElement(CustomFileUpload).sendKeys("D:\\\\GaneshNovemberGit\\\\selenium-maven-pom\\\\src\\\\test\\\\resources\\\\Videohtmlzip1758794348241 (1).zip");
		Thread.sleep(3000);
		WaitUtil.waitAndClick(driver, SaveCustomTemp, 20);
