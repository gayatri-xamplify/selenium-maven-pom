...
public class ManageSurveyCampaignPage {

	private static WebDriver driver;
	private WebDriverWait wait;
	private static final Logger logger = LogManager.getLogger(ManageSurveyCampaignPage.class);

	public ManageSurveyCampaignPage(WebDriver driver) {
		this.driver = driver;
	...
	private By SurveyEdit = By.xpath("//table[@id=\"manage-campaign-list\"]/tbody/tr[1]/td[4]/div/div/ul/li[1]/a");
	...
	private By SurveyCopy = By.xpath("//*[@id=\"manage-campaign-list\"]/tbody/tr[1]/td[4]/div/div/ul/li[2]/a[1]");
	private By SurveyCopySaveChanges = By
	...
	// Total Survey sent tile
	private By totalSurveySentTile = By.xpath("//div[1]/div[2]/div[1]/section[1]/div[1]/div[2]/button[1]");
	private By totalSurveySentSearchBox = By
			.xpath("//div[contains(@class,'modal right fade in')]//input[contains(@placeholder,'Search')]");
	private By totalSurveySentSearchIcon = By
			.xpath("//div[contains(@class,'modal right fade in')]//i[contains(@class,'fa fa-search')]");
	private By totalSurveySentClearSearch = By.xpath(
			"//div[contains(@class,'modal right fade in')]//span[contains(@class,'glyphicon glyphicon-remove')]");
	private By totalSurveySentExportDropdown = By
			.xpath("//div[contains(@class,'modal right fade in')]//i[contains(@class,'fa fa-angle-down')]");
	private By totalSurveySentExportExcel = By
			.xpath("//div[@class='btn-group gear-icon open']//a[contains(text(),'Export To Excel')]");
	private By totalSurveySentCloseModal = By
			.xpath("//div[contains(@class,'modal right fade in')]//i[contains(@class,'fa fa-times')]");
	...
	private By activeRecipientsSearchClear = By
			.xpath("//*[@id=\"SurveyActionListModal\"]/div/div/div[1]/div[2]/div[2]/button[1]/span");
	...
	public void openSurveyTab() {
		logger.info("Opening Survey tab in Manage Campaigns...");
	...
	public void editSurveyCampaign() throws InterruptedException {
		logger.info("Editing first Survey campaign...");
		...
		WaitUtil.safeJsClick(driver, SurveyEdit);
		...
		desc.sendKeys("Hello Survey Campaign");
	...
	public void copySurveyCampaign() throws Exception {
		logger.info("Copying first Survey campaign...");
		...
		safeClick(SurveyCopy);
		Thread.sleep(600);

		// 5️⃣ Click Save Changes using helper
		safeClick(SurveyCopySaveChanges);
	...
	public void previewOnlyView() throws Exception {
		logger.info("Previewing Survey Campaign and closing preview...");
		Thread.sleep(1000);
	...
	public void archiveAndUnarchiveCampaign() throws InterruptedException {
		...
		// 4️⃣ BEFORE clicking Survey tab — fix overlap issue
		scrollDown(300);
		Thread.sleep(300);

		// 5️⃣ Click Survey tab using helper
		scrollIntoCenter(SurveyTab);
		safeClick(SurveyTab);
	...
	public void deleteSurveyCampaign() throws InterruptedException {
		logger.info("Deleting first Survey campaign...");
		Thread.sleep(1000);
	...
	public void openCampaignAnalytics() throws InterruptedException {
		logger.info("Opening Survey campaign analytics...");
	...
	// ---------- 9.2 Total Survey Sent ----------

	public void handleTotalSurveySentTile() {
		logger.info("Handling Total Survey Sent tile...");

		WaitUtil.waitAndClick(driver, totalSurveySentTile, 60);
		WaitUtil.waitForPageToLoad(driver, 60);

		wait.until(ExpectedConditions.visibilityOfElementLocated(totalSurveySentSearchBox));

		ElementUtil.sendText(totalSurveySentSearchBox, "mounika", driver);
		WaitUtil.waitAndClick(driver, totalSurveySentSearchIcon, 60);
		WaitUtil.waitAndClick(driver, totalSurveySentClearSearch, 60);

		WaitUtil.waitAndClick(driver, totalSurveySentExportDropdown, 60);
		WaitUtil.waitAndClick(driver, totalSurveySentExportExcel, 60);

		WaitUtil.waitAndClick(driver, totalSurveySentCloseModal, 60);
	}
	...
	public void manageSurveyCampaignFullFlow() throws Exception {
		...
		goToHome();
		logger.info("Manage Survey Campaign full flow completed successfully.");
	}
