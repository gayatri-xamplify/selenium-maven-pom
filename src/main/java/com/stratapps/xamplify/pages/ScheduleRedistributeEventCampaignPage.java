...
public class ScheduleRedistributeEventCampaignPage {

	private WebDriver driver;

	public ScheduleRedistributeEventCampaignPage(WebDriver driver) {
		this.driver = driver;
	}

	// ================= Locators =================
	private By scheduleOption = By.xpath("(//span[contains(text(),'Schedule')])[1]");
	private By launchTimeInput = By.xpath("//input[@id='launchTimeInString']");
	...
	public boolean scheduleRedistributionEvent(String countryValue) throws InterruptedException {
