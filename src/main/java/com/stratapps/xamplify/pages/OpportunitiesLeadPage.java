...
// Locators
	...
	public static final By leadForCompany = By
	...
	public static final By address = By
			.xpath("//textarea[@class='form-control ng-tns-c35-3 ng-pristine ng-valid ng-touched']");
	...
	public static final By campaignViewleadslist = By
			.xpath("//a[@data-original-title='View leads for this campaign']/i");
	...
	// public static final By leadsFilterAddedFor =
	// By.xpath("(//ejs-dropdownlist[@id=\"ddlelement\"])[3]");
	...
	public static final By totalLeadCount = By
			.xpath("//div[@id='deals-page-content-div']//div[@class='number']/span)[1]");
	public static final By wonLeads = By.xpath("//div[@class='desc' and contains(text(),'Won Leads')]");
	public static final By wonLeadsCount = By
			.xpath("//div[@id='deals-page-content-div']//div[@class='number']/span)[2]");
	public static final By lostLeads = By.xpath("//div[@class='desc' and contains(text(),'Lost Leads')]");
	public static final By lostLeadsCount = By
			.xpath("//div[@id='deals-page-content-div']//div[@class='number']/span)[1]");
	public static final By convertedLeads = By.xpath("//div[@class='desc' and contains(text(),'Converted Leads')]");
	public static final By convertedLeadsCount = By
			.xpath("//div[@id='deals-page-content-div']//div[@class='number']/span)[1]");
	// The below values are not unique. To use it uniquely, first search for the
	// lead then perform what action you want to perform. or use index
	...
	public static final By leadViewCommentsSubmit = By
			.xpath("//button[contains(@class,'btn btn-primary transition mb')]");
	...
	public static final By leadLastPage = By
			.xpath("//i[@class='fa fa-angle-double-right' and contains(@title,'Last')]");
	public static final By leadPreviousPage = By
			.xpath("(//i[@class='fa fa-angle-left' and contains(@title,'Previous')])[1]");
