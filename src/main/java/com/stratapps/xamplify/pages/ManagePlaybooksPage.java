...
public class ManagePlaybooksPage {
	...
	private By updatePlaybook = By.xpath("//span[normalize-space()='Update']");
	...
	private By previewPlaybook = By.xpath("(//i[@class='fa fa-eye IconCustomization'])[1]");
	...
	private By PlaybookNavigation = By.xpath("//a[normalize-space()='Manage Playbooks']");

	private By PlaybookAnalytics = By.xpath("(//i[@class='fa fa-line-chart IconCustomization'])[1]");
	...
	private By searchPlaybook = By.xpath("//input[@placeholder='search...']");
	private By deletePlaybook = By.xpath("(//i[@class='fa fa-trash-o trashIconCustomization'])[1]");
	...
	private By PlaybookGroupDropdown = By.xpath("//div[@class='group-dropdown']");
	private By gridViewBtn = By.xpath("(//span[@class='btn btn-xs l-g-view margin-space'])[1]");
	private By gridAsset = By.xpath("(//img[@class='img-grid-Playbook'])[1]");
	private By editGridPlaybook = By.xpath("(//i[@class='fa fa-pencil-square-o'])[1]");
	...
	private By viewFolderPlaybooks = By.xpath("//a[@class='Iconhover custom-icon']");
	...
	public void publishPlaybook() {
		WaitUtil.waitAndClick(driver, publishIcon, 60);
		WaitUtil.waitAndClick(driver, confirmPublish, 60);

	}

	public void previewPlaybookAndReturn() {

		WaitUtil.waitAndClick(driver, previewPlaybook, 50);
		WaitUtil.waitAndClick(driver, previewPlaybook, 50);
		WaitUtil.waitForPageToLoad(driver, 60);
	...
	public void viewPlaybookAnalytics() {

		WaitUtil.waitForPageToLoad(driver, 70);
		WaitUtil.waitForInvisibilityOfElement(backdrop, driver, 60);
		WaitUtil.waitAndClick(driver, PlaybookAnalytics, 60);
		WaitUtil.waitForPageToLoad(driver, 70);
		WaitUtil.waitForInvisibilityOfElement(backdrop, driver, 60);
		...
		WaitUtil.waitForPageToLoad(driver, 70);
		WaitUtil.waitForInvisibilityOfElement(backdrop, driver, 60);
		ElementUtil.click(PlaybookNavigation, driver);
	}

	public void sortAndDeletePlaybook() {
		WaitUtil.waitForPageToLoad(driver, 70);
		WaitUtil.waitForInvisibilityOfElement(backdrop, driver, 60);
	...
	public void PlaybookViews(String localFilePath) {
		WaitUtil.waitForPageToLoad(driver, 70);
		WaitUtil.waitForInvisibilityOfElement(backdrop, driver, 60);
		ElementUtil.click(PlaybookGroupDropdown, driver);
		...
		ElementUtil.click(editGridPlaybook, driver);
		...
		ElementUtil.clickWhenReady(driver, updatePlaybook, 30);

		WaitUtil.waitForVisibility(driver, refreshButton, 70);
		ElementUtil.clickWhenReady(driver, refreshButton, 30);

		ElementUtil.clickWhenReady(driver, PlaybookGroupDropdown, 30);
		...
		ElementUtil.clickWhenReady(driver, viewFolderPlaybooks, 30);

		WaitUtil.waitAndClick(driver, goBackArrow, 60);
		WaitUtil.waitForPageToLoad(driver, 70);

		WaitUtil.waitAndClick(driver, PlaybookGroupDropdown, 60);
		WaitUtil.waitForPageToLoad(driver, 70);
		WaitUtil.waitForInvisibilityOfElement(backdrop, driver, 60);
		WaitUtil.waitForVisibility(driver, folderView, 70);
		...
		WaitUtil.waitAndClick(driver, PlaybookGroupDropdown, 80);
