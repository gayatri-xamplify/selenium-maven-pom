...
public class EventCampaignPage {
    ...
    private By selectDate = By.xpath("//div[contains(@class,'open')]//span[contains(@class,'flatpickr-day today')]/following-sibling::span[2]");
    ...
    private By templatePreview = By.xpath("//*[@id=\"event-tabs\"]/div[2]/div[1]/div[1]/div[2]/section/ul[1]/li/div/div/div/div/div/span[2]/a/i");
    private By templateEdit = By.xpath("//a/div/div/span");
    private By templateEditClose = By.xpath("//*[@id='edit-template']//a/i");
    private By nextPage3 = By.xpath("//div[contains(@class,'button-group-align')]//span[contains(@class,'btn Btn-Green transition txt_pd-top3')][normalize-space()='Next']");
    ...
    public void selectPartnerList() throws Exception {
        ...
        ElementUtil.sendText(partnerSearch, "Active Master", driver);
    ...
    public void selectTemplate() throws Exception {
        ...
        WaitUtil.waitForElementVisible(driver, templateEdit, 30);
        WaitUtil.waitAndClick(driver, templateEdit, 60);
        WaitUtil.waitForInvisibilityOfElement(backdrop, driver, 60);
        WaitUtil.waitForElementVisible(driver, templateEditClose, 60);
        WaitUtil.waitAndClick(driver, templateEditClose, 60);
