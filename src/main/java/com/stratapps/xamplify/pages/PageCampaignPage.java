...
public class PageCampaignPage {

    private WebDriver driver;

    public PageCampaignPage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    private By openPageCampaign = By.xpath("//h4[normalize-space()='Page']");
    private By campaignName = By.id("campaignName");
    private By publicPartner = By.xpath("//span[@class='bootstrap-switch-handle-off bootstrap-switch-success']");
    private By subjectLine = By.id("subjectLineId");
    private By preheader = By.id("preHeader");
    private By notifypublic = By.xpath("(//span[@class='bootstrap-switch-label'])[1]");
    ...
    private By clickSendTestPage = By.xpath("(//button[.//span[contains(text(),'Send Test Page')]])[1]");
    private By sendTextPage = By.xpath("//input[@placeholder='Please Enter Page Address']");
    private By sendTextPageSubject = By.xpath("//input[@placeholder='Please Enter Page Subject']");
    private By sendPageButton = By.xpath("//div[@id='send-test-Page-modal-popup']//button[2]/span");
    private By PageSentPopup = By.xpath("//button[contains(text(),'OK')]");
    ...
    // ==========================
    public void createPageCampaign(String name, String subject, String preHeader, String Page, String PageSubject) {
        ...
        WaitUtil.waitAndClick(driver, openPageCampaign, 60);
        ...
        try {
            WaitUtil.waitForElementClickable(driver, publicPartner, 30);
            ElementUtil.click(publicPartner, driver);
        } catch (ElementClickInterceptedException e) {
            WebElement toggle = driver.findElement(publicPartner);
        ...
        //ElementUtil.click(notifypublic, driver);
      
        // 6️⃣ Select Page Template
        WaitUtil.waitForElementVisible(driver, templateSearch, 60);
        ElementUtil.sendText(templateSearch, "Page", driver);
        ElementUtil.sendKey(templateSearch, Keys.ENTER, driver);
        WaitUtil.waitAndClick(driver, templateSelect, 60);
        WaitUtil.waitForPageToLoad(driver, 60);

//        // 7️⃣ Send Test Page
//        WaitUtil.waitForElementClickable(driver, clickSendTestPage, 60);
//        try {
//            ElementUtil.click(clickSendTestPage, driver);
//        } catch (ElementClickInterceptedException e) {
//            WebElement btn = driver.findElement(clickSendTestPage);
//            ((JavascriptExecutor) driver).executeScript("arguments[0].click();", btn);
//        }
//
//        WaitUtil.waitForElementVisible(driver, sendTextPage, 60);
//        ElementUtil.sendText(sendTextPage, Page, driver);
//        ElementUtil.sendKey(sendTextPage, Keys.ENTER, driver);
//        ElementUtil.sendText(sendTextPageSubject, PageSubject, driver);
//        ElementUtil.sendKey(sendTextPageSubject, Keys.ENTER, driver);
//
//        WaitUtil.waitAndClick(driver, sendPageButton, 60);
//        WaitUtil.waitAndClick(driver, PageSentPopup, 60);
