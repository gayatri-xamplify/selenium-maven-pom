...
public class ScheduleRedistributeEmailCampaignPage {

	private WebDriver driver;

	public ScheduleRedistributeEmailCampaignPage(WebDriver driver) {
		this.driver = driver;
	}
	...
	public boolean scheduleRedistributionEmail(String countryValue) throws InterruptedException {
