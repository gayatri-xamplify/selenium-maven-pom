...
public class SaveEventCampaignPage {
	...
	private By spamCheckBtn = By.xpath("//span[@class='btn Btn-Green transition txt_pd-top3'][contains(text(),'Spam')]");
	...
	private By refreshInsideSpamCheckBtn = By
			.xpath("//a[normalize-space()='Refresh']");
	private By spamCheckCloseBtn = By.xpath("//div[@class='modal-dialog modal-lg modal-template mEventSpamPopUp']//a[@class='Btn-Gray'][normalize-space()='Close']");
	private By saveClickBtn = By.xpath("//span[contains(@class,'btn Btn-Green transition txt_pd-top3')][normalize-space()='Save']");
