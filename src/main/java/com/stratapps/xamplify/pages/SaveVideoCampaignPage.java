...
public class SaveVideoCampaignPage {
	...
	private By saveInsideSpamCheckBtn = By
			.xpath("//*[@id='email_spam_check']/div/div/div[2]/app-email-spam-check/div[1]/button/span");
	...
	public void saveVideoCampaign(String email, String subject) throws InterruptedException {
		clickTestMail();
